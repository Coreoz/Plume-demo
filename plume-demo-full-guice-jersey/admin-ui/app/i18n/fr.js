var translations_fr = {
	...
	"wsError" : {
		...
		"TOO_MANY_WRONG_ATTEMPS" : "Suite à des erreurs dans la saisie de vos identifiants, votre compte est verrouillé pendant {{args[0]}} minutes, veuillez-vous reconnecter ultérieurement",
